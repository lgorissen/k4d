...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k create -f terra10-job.yaml 
job.batch/terra10-batch-job created
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k get jobs.batch terra10-batch-job 
NAME                DESIRED   SUCCESSFUL   AGE
terra10-batch-job   1         0            18s
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k get pod
NAME                      READY     STATUS              RESTARTS   AGE
terra10-batch-job-ls476   0/1       ContainerCreating   0          3s
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k logs terra10-batch-job-ls476 
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k get jobs.batch 
NAME                DESIRED   SUCCESSFUL   AGE
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k delete job terra10-batch-job 
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k create -f terra10-multiple-job.yaml 
job.batch/terra10-mulitple-job created
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k get jobs
NAME                   DESIRED   SUCCESSFUL   AGE
terra10-mulitple-job   5         0            3s
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k get pods
NAME                         READY     STATUS    RESTARTS   AGE
terra10-mulitple-job-5m74c   1/1       Running   0          8s
terra10-mulitple-job-jdss5   1/1       Running   0          8s
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k logs terra10-mulitple-job-5m74c 
Sun Sep 23 17:27:46 UTC 2018 Work started at Terra10
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k logs terra10-mulitple-job-jdss5 
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 12$ k get jobs terra10-mulitple-job 
NAME                   DESIRED   SUCCESSFUL   AGE
