...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k create -f terra10-replicationcontroller.yaml 
replicationcontroller/terra10-rc created
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k get rc
NAME         DESIRED   CURRENT   READY     AGE
terra10-rc   3         3         3         7s
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k get pod
NAME               READY     STATUS    RESTARTS   AGE
terra10-rc-5hv5q   1/1       Running   0          10s
terra10-rc-7sxhr   1/1       Running   0          10s
terra10-rc-xmtlm   1/1       Running   0          10s
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k create -f terra10-service-loadbalancer.yaml 
service/terra10-loadbalancer created
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k get service
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k describe service terra10-loadbalancer | grep "^IP"
IP:                       10.103.201.231
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k rolling-update terra10-rc terra10-rc-r2 --image=lgorissen/terra10:r2
```
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k describe rc terra10-rc-r2 
Name:         terra10-rc-r2
Namespace:    default
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k get pod --show-labels 
...
```bash
developer@developer-VirtualBox:~/projects/k4d/lab 32$ k describe service terra10-loadbalancer 
Name:                     terra10-loadbalancer
Namespace:                default
Labels:                   <none>
Annotations:              <none>
